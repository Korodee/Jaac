...
const plans = [
    {
        ...
        features: [
            ...
            "Support par email",
            "Accès à la bibliothèque de méditation guidée",
        ],
        popular: false,
        gradient: "from-purple-500 to-indigo-500",
        description:
            "Parfait pour les individus recherchant un soutien et un accompagnement psychologique régulier.",
    },
    {
        id: "coupdemain",
        title: "Coup de Main",
        ...
        description:
            "Idéal pour un soutien immédiat et une résolution rapide des problèmes.",
    },
    {
        id: "enterprise",
    ...
    const handlePlanSelect = async (planId: string) => {
        ...
        try {
            ...
            if (!result.success) {
                ...
                setErrorMessage(
                    result.error ||
                        "Une erreur s'est produite lors de la création de l'abonnement"
                );
            }
        } catch (error) {
            ...
            <div className="container mx-auto px-4 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {plans.map((plan, index) => (
                        ...
                        >
                            <div
                                className={`absolute inset-0 bg-gradient-to-br ${plan.gradient} rounded-2xl transform rotate-1 group-hover:rotate-0 transition-transform duration-300 opacity-10`}
                            />
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-purple-100 group-hover:shadow-xl transition-shadow duration-300 h-full flex flex-col">
                                ...
                                <ul className="space-y-3 mb-8 flex-grow">
                                    {plan.features.map((feature, i) => (
                                        ...
                                        >
                                            <div
                                                className={`p-1 rounded-full bg-gradient-to-br ${plan.gradient} mr-3`}
                                            >
                                ...
                                <button
                                    ...
                                    className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl py-3 px-6 font-medium hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
                                >
                                    Choisir le forfait
                                </button>
                            </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-8 md:p-10 shadow-xl border border-purple-100/50 overflow-hidden">
                            ...
                            <p className="text-lg text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
                                Maintenant accessible au secteur privé. Suivi
                                psychologique à court terme, en hébergement ou à
                                domicile, pour une situation d'impasse.
                            </p>
                                ...
                                {[
                                    {
                                        ...
                                        description:
                                            "Réservez vos séances à votre convenance",
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        description:
                                            "Approche personnalisée à vos besoins",
                                    },
                                ].map((item, i) => (
                                    <motion.div
                                        key={i}
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            className={`p-4 rounded-full bg-gradient-to-r ${item.color} text-white mb-3 transform group-hover:scale-110 transition-transform duration-300`}
                                        >
                                            {item.icon}
                                        </div>
                                ...
                                {paymentStatus === "success" && (
                                    <div className="py-12 text-center">
                                        ...
                                        <p className="text-gray-600">
                                            Votre abonnement a été activé avec
                                            succès.
                                        </p>
                                        <p className="text-gray-600 mt-2">
                                            Un email de confirmation a été
                                            envoyé à {formData.email}.
                                        </p>
                                        {subscriptionId && (
