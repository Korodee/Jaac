            ...
            <div className="container  mx-auto px-4 relative">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        Vous avez des questions ou besoin d'assistance ? Nous
                        sommes là pour vous aider. Remplissez le formulaire
                        ci-dessous et nous vous répondrons dans les plus brefs
                        délais.
                    </p>
                </motion.div>
                                ...
                                {submitStatus === "success" ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-red-600">
                                            Veuillez réessayer plus tard ou nous
