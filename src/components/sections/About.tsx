...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Des forfaits mensuels abordables pour faciliter l'accès à nos services.",
  ...
  },
  {
    ...
    description:
      "Des programmes de soutien adaptés aux entreprises et à leurs employés.",
  ...
  },
  {
    ...
    description:
      "Nous mettons en place des programmes de soutien qui contribuent au bien-être des individus et des entreprises.",
...
export default function About() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-[3rem] md:py-[6rem] overflow-hidden"
    >
      {/* Static Background */}
      ...
      <div className="container pt-[5rem] md:pt-[3rem] mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-lg text-gray-700 leading-relaxed pl-8 relative">
                  Depuis 2015, JAAC fournit des services paramédicaux
                  professionnels, une thérapie psychologique et un soutien à la
                  santé holistique pour le personnel et leurs familles, ainsi
                  que pour la population générale, afin d'optimiser leur
                  potentiel.
                </p>
              ...
              >
                ...
                <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-purple-100 group-hover:shadow-xl transition-shadow duration-300">
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Notre mode de vie actuel exige une pause pour traiter les
                    expériences difficiles afin de pouvoir rebondir
                    efficacement. JAAC a été fondée pour faciliter cette pause,
                    intervenant rapidement et de manière appropriée auprès des
                    individus grâce à des interventions brèves et pragmatiques.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative bg-gradient-to-r from-purple-600 to-indigo-600 p-8 rounded-2xl shadow-xl group-hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <p className="text-lg font-medium leading-relaxed text-white relative">
                    JAAC a développé une structure d'abonnement mensuel unique
                    adaptée aux besoins fondamentaux des individus en matière de
                    soutien psychologique. Vous serez accueilli comme une
                    personne entière.
                  </p>
                </div>
              </motion.div>
          ...
          <motion.div className="relative h-[600px] group" style={{ y }}>
            ...
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="relative z-10 h-full bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-lg border border-purple-100 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
                  <div
                    className={`inline-flex p-4 rounded-xl bg-gradient-to-br ${benefit.gradient} mb-6 text-white transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-6`}
                  >
                    {benefit.icon}
                  </div>
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${benefit.gradient} opacity-0 group-hover:opacity-5 rounded-2xl blur-xl transition-all duration-500 transform-gpu group-hover:scale-105`}
                />
              </motion.div>
            ))}
          </div>
